...
import 'package:lawan_ui/widgets/custom_add_referee.dart';
              ...
              SizedBox(
                ...
                child: Obx(
                  () => ListView.builder(
                    ...
                    itemCount: lobbyController.refereesdata.length,
                    itemBuilder: (context, index) {
                      var user = lobbyController.refereesdata[index];
                      if (user['status'] == 'notReferee') {
                        return MakeReferee(
                          ...
                          onAddReferee: () {
                            lobbyController.showConfirmationDialog(index);
                          },
                        );
